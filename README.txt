...
•	“Musthave” things;
•	Interesting locations (with link to maps via intent);
•	Helpful internet resources (links via intent);

In the version 0 it contains such activities as hiking, bicycle touring, camping and snowboarding (the the things which author prefer to do on his day off). In the nearest future is planned:
